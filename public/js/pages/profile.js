...
function setDateMonthEdit() {
    document.getElementById("year").value = yearEdit;
    document.getElementById("month").value = monthEdit;
    document.getElementById("day").value = dateEdit;
}